...
public class AddressBook {
    ...
    private static void setupDefaultFileForStorage() {
        showToUser(MESSAGE_USING_DEFAULT_FILE); //show default msg
        storageFilePath = DEFAULT_STORAGE_FILEPATH; //used default storage location addressbook.txt
...
//            }
         //   Iterator<String> wordInNameItr = wordsInName.iterator();
            ...
            for (String wordInName: wordsInName)
            {
               // System.out.println("Word in name are: "+ wordInName);
                for (String keyword: keywords)
                {
                    ...
                    //System.out.println("Keywords are: "+ keyword);
                }
            }
        }
    ...
    */
     ...
     */
    private static Optional<HashMap<String,String>> decodePersonFromString(String encoded) {//place to decode input typed in
